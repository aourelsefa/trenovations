...
export const metadata: Metadata = {
  title: "Ανακαίνιση Μπάνιου Αθήνα | Trenovations - Εξειδικευμένη Ανακαίνιση",
  description: "Εξειδικευμένη ανακαίνιση μπάνιου στην Αθήνα με σύγχρονο σχεδιασμό, εργονομία και υψηλής ποιότητας υλικά. Δωρεάν εκτίμηση, επαγγελματική εγκατάσταση νιπτήρων, καμπινών και υδραυλικών. Εγγύηση ποιότητας.",
  keywords: "ανακαίνιση μπάνιου Αθήνα, σχεδιασμός μπάνιου, μπάνιο, ανακαίνιση, trenovations, νιπτήρες, καμπίνες, υδραυλικά, εγκατάσταση μπάνιου, ανακαίνιση σπιτιού Αθήνα",
  ...
  openGraph: {
    title: "Ανακαίνιση Μπάνιου Αθήνα | Trenovations - Εξειδικευμένη Ανακαίνιση",
    description: "Εξειδικευμένη ανακαίνιση μπάνιου στην Αθήνα με σύγχρονο σχεδιασμό και υψηλής ποιότητας υλικά. Δωρεάν εκτίμηση και επαγγελματική εγκατάσταση.",
    type: "website",
    url: "https://trenovations.gr/services/anakainisi-mpaniou",
    siteName: "Trenovations",
    locale: "el_GR",
    images: [
      {
        url: "https://trenovations.gr/images/bathroom-renovation.jpg",
        width: 1200,
        height: 630,
        alt: "Ανακαίνιση Μπάνιου - Trenovations",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Ανακαίνιση Μπάνιου Αθήνα | Trenovations",
    description: "Εξειδικευμένη ανακαίνιση μπάνιου στην Αθήνα με σύγχρονο σχεδιασμό και υψηλής ποιότητας υλικά.",
    images: ["https://trenovations.gr/images/bathroom-renovation.jpg"],
  },
  alternates: {
    canonical: "https://trenovations.gr/services/anakainisi-mpaniou",
  },
...
const PROCESS_STEPS = [
  {
    ...
    description: "Ανάλυση των αναγκών σας και δημιουργία προσαρμοσμένου σχεδίου μπάνιου"
  },
  {
    step: "2", 
  ...
  },
  {
    ...
    description: "Ελέγχος ποιότητας και παράδοση έτοιμου μπάνιου"
  }
];

const SERVICES_INCLUDED = [
  "Σχεδιασμός και διαμόρφωση χώρου",
  "Εγκατάσταση νιπτήρα και καμπίνης",
  "Τοποθέτηση πλακών και πλακιδίων",
  "Εγκατάσταση υδραυλικών",
  "Ηλεκτρολογικές εργασίες",
  "Εγκατάσταση καθαριστικών",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed">
              Ανανεώστε το μπάνιο σας με σύγχρονο σχεδιασμό, εργονομία 
              και υψηλής ποιότητας υλικά για μέγιστη άνεση και λειτουργικότητα.
            </p>
